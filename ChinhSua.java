...
public class ChinhSua extends JFrame implements ActionListener{
	JPanel p1,p2; // tao 2 khung
	JLabel l1,l2,l3,l4,l5,l55,l6,l66; // tao 8 cai nhan
	JTextField t1,t2,t3,t4,t5,t55,t6,t66; // tao 8 cai TextField
	JButton b1,b2; // tao hai nut nhan
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("OK")) {
			...
			if(new JDBCConnection().chinhSuaHangHoa(clone, clone.getId())) {
				...
				JOptionPane.showMessageDialog(rootPane, "Chỉnh sửa hàng hoá thành công!");
				this.dispose();
			}
		}
		else 
