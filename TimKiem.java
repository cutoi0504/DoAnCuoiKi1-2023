	...
	public TimKiem(String s, ArrayList<HangHoa> h, String tk) {
		...
		for (HangHoa o : h) {
			if ((o.getId().equals(tk))||(o.getTen().equals(tk))) {
				...
				l2 = new JLabel("Tên : "+o.getTen());
				l2.setHorizontalAlignment(SwingConstants.CENTER);
				l3 = new JLabel("Giá : "+String.valueOf(o.getGia()));
				l3.setHorizontalAlignment(SwingConstants.CENTER);
				l4 = new JLabel("Số lượng trong kho : "+String.valueOf(o.getSoLuong()));
				l4.setHorizontalAlignment(SwingConstants.CENTER);
				l5 = new JLabel("Số lượng đã nhập kho : "+String.valueOf(o.getDaNhap()));
				l5.setHorizontalAlignment(SwingConstants.CENTER);
				l6 = new JLabel("So lượng đã xuất kho : "+String.valueOf(o.getDaXuat()));
